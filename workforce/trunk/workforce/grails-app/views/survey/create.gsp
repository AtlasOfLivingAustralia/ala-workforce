            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="year"><g:message code="survey.year.label" default="Survey Year"/></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="priorYear1"><g:message code="survey.priorYear1.label" default="Prior Year1"/></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="priorYear2"><g:message code="survey.priorYear2.label" default="Prior Year2"/></label>
                    </td>
